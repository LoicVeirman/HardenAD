...
# Log schedule start
Write-EventLog -LogName Application -source "HardenAD_Clear-ADComputerSDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "A new computer named '$Computer' has been detected."
...
$Array | foreach {
    ...
    Try   {
            ...
            # Write to event log
            Write-EventLog -LogName Application -source "HardenAD_Clear-ADComputerSDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "The computer '$Computer' owner has been refreshed to $DAName"
          }
    Catch {
            # Failed.
            $Code += 1
    ...
    Else 
    {
        Try   {
                ...
                # Write to event log
                Write-EventLog -LogName Application -source "HardenAD_Clear-ADComputerSDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "The computer '$Computer' SDDL has been recycled to its default value."
