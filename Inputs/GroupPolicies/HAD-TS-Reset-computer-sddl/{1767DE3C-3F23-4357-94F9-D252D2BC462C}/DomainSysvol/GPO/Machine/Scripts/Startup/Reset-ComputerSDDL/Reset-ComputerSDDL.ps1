...
# Log schedule start
Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "A new computer named '$Computer' has been detected."
...
$Array | foreach {
    ...
    Try   {
            ...
            # Write to event log
            Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "The computer '$Computer' owner has been refreshed to $DAName"
          }
    Catch {
            # Failed.
            $Code += 1
            ...
            # Write to event log
            Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType FailureAudit -EventId $Code -Category 0 -Message "The computer '$Computer' owner could not be modified to $DAName!"
          }
    ...
    { 
        ...
        # Write to event log
        Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType FailureAudit -EventId $Code -Category 0 -Message "The computer '$Computer' ntSecurityDescriptor could not be retrieved!"
    ...
    Else 
    {
        Try   {
                ...
                # Write to event log
                Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType SuccessAudit -EventId 0 -Category 0 -Message "The computer '$Computer' SDDL has been recycled to its default value."
        ...
        Catch {
                ...
                # Write to event log
                Write-EventLog -LogName Application -Source "HAD_TS_Reset-Computer-SDDL" -EntryType FailureAudit -EventId $Code -Category 0 -Message "The computer '$Computer' SDDL could not be refreshed!"
